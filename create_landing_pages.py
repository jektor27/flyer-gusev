...
shops_data = {
    ...
    "Стройматериалы": [
        {"name": "Тёплый дом", "address": "Школьная ул., 11", "phone": "+7 (40143) XXX-XX-XX", "products": "Кирпич, цемент, доски, краска, инструменты", "badge": "Стройматериалы"},
        {"name": "Фазенда", "address": "Московская ул., 33А", "phone": "не указан", "products": "Инструменты, крепёж, электрика, сантехника", "badge": "Строительный магазин"}
    ],
    "Одежда": [
        {"name": "Kari Гипер", "address": "просп. Ленина, 21А", "phone": "+7 (499) 648-05-40", "products": "Обувь для всей семьи", "badge": "Одежда"},
        {"name": "Золотая комета", "address": "ул. Ломоносова, 5", "phone": "+7 (4012) 61-40-02", "products": "Одежда, аксессуары", "badge": "Одежда"},
