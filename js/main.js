...
const shopsData = [
    ...
    {id:53,name:"ЦентрСтрой",category:"stroymaterialy",address:"Артиллерийская ул., 5",phone:"+7 (4012) 64-05-45",description:"Строительный гипермаркет — стройматериалы для дома и ремонта: кирпич, цемент, отделочные материалы, инструменты",products:["Стройматериалы","Кирпич","Цемент","Отделочные материалы","Инструменты"],badge:"Стройматериалы",rating:4.6,website:"https://centrstroy.ru"}
]
